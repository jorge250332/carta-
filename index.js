document.addEventListener('DOMContentLoaded', () => {
  ...
  const typingConfig = {
    lines: [
      "¡Feliz cumpleaños!  Espero que te la pases súper hoy en tu día especial. Lástima que no cumpliste el 16 para que se juntara con la ley seca, porque conociéndote hoy sí te vas a acabar toda la cheve.",
      "Aunque a veces me haces enojar (casi siempre ), eso no quita el cariño que te tengo. Espero que te vaya increíble no solo hoy, sino siempre, y que cumplas muchos años más.",
...
const initScratch = () => {
	...
	scratchContext.fillStyle = "rgba(255,255,255,0.9)";
	scratchContext.font = "600 16px Outfit";
	...
	scratchContext.font = "28px Arial";
